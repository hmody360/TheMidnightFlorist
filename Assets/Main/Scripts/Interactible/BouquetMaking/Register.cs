...
public class Register : MonoBehaviour, Iinteractable
{
    ...
    public void Interact()
    {
        if (!gameManager.getStoreStatus() && !gameManager.getFinishStatus())
        {
            ...
            UIManager_Day.instance.setPromptText("The Shop has been Opened!", Color.green, true);
        ...
        else if (gameManager.getStoreStatus() && !gameManager.getFinishStatus())
        {
            ...
            if (canStoreClose)
            {
                ...
                _screenRenderer.sharedMaterials = tempMatList;
                UIManager_Day.instance.setPromptText("The Shop has been Closed!", Color.red, true);
            ...
            {
                UIManager_Day.instance.setPromptText("You Haven't met the quota yet!", Color.red, true);
        ...
        {
            UIManager_Day.instance.setPromptText("Don't Overwork Yourself!", Color.red, true);
